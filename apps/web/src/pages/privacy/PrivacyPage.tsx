        ...
        <Container>
          <div className={styles.content}>
            ...
            <div className={styles.notice}>
              <strong>Редакция для макета.</strong> Оператор — {site.operator}. Контактные данные и
              реквизиты ниже временные. До публичного запуска оператор должен подтвердить
              окончательные условия обработки, срок хранения, получателей данных и порядок
              обращений.
            </div>
            <section>
              ...
              <p>
                ...
                <a href={site.phoneHref}>{site.phone}</a>. Эти контакты и цифровые реквизиты
                приведены для макета и подлежат замене.
              </p>
            </section>
            <section>
