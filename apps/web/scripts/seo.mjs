...
const heroPreload =
  '<link rel="preload" as="image" href="/images/hero-team-20260922.webp" imagesrcset="/images/hero-team-20260922-768.webp 768w, /images/hero-team-20260922.webp 1440w" imagesizes="(max-width: 500px) calc(100vw - 40px), (max-width: 950px) 92vw, (max-width: 1435px) 44vw, 634px" fetchpriority="high"/>';
for (const [path, pageTitle, description] of routes) {
  ...
  const meta =
    ...
    escape(new URL('/images/hero-team-20260922.webp', origin).href) +
